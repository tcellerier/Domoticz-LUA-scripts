...
-------------------------------------------------------------
--  Change la couleur de la lampe toutes les 20 secondes pendant 1 heure
...
if (otherdevices['Lampe chambre Color Change'] == 'On') then
    ...
    brightness = uservariables['Script_Lamp_brightness']  -- intensité de 1 à 100
    hue = uservariables['Script_Lamp_color_hue']  -- couleur actuelle (de 0 à 359)
    first_hue = tostring((hue  + 1) % 360)
    frequence = uservariables['Script_Lamp_Freq_Change']  -- Fréquence de change des couleurs / minute (de 1 à 6)
    server = '127.0.0.1' 
